...
EMFB_STK_API void emfb_stk_guitar_tickInplace(void *self, void *frames, unsigned int channel);

EMFB_STK_API void emfb_stk_guitar_tick(void *self, void *iFrames, void *oFrames, unsigned int iChannel, unsigned int oChannel);

EMFB_STK_API void emfb_stk_guitar_tickSubInplace(void *self, void *frames, unsigned int offset, unsigned int length, unsigned int channel);
