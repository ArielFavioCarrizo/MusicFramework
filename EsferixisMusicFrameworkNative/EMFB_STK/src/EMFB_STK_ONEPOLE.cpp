...
void emfb_stk_onepole_tickSubInplace(void *self, void *frames, unsigned int offset, unsigned int length, unsigned int channel) {
	emfb_stk_tickSubInplace<stk::OnePole>(self, frames, offset, length, channel);
}

void emfb_stk_onepole_tickSub(void *self, void *iFrames, void *oFrames, unsigned int iOffset, unsigned int oOffset, unsigned int length, unsigned int iChannel, unsigned int oChannel) {
	emfb_stk_tickSub<stk::OnePole>(self, iFrames, oFrames, iOffset, oOffset, length, iChannel, oChannel);
}