...
unhandledOneZeroAction oneZero nativeFun actionFun = withForeignPtr ( oneZeroForeignPtr oneZero ) (\c_oneZeroPtr -> actionFun ( nativeFun c_oneZeroPtr ) )
...
oneZeroSetCoefficients oneZero b0 b1 clearState = unhandledOneZeroAction oneZero c_emfb_stk_onezero_setCoefficients (\fun -> fun ( CDouble b0 ) ( CDouble b1 ) ( hsctypeconvert clearState ) )

oneZeroSetZero = createSetValue c_emfb_stk_onezero_setZero

oneZeroTickInplace :: OneZero -> StkFrames -> Word32 -> IO ()
oneZeroTickInplace = createStkFramesTickInplaceFun unhandledOneZeroAction c_emfb_stk_onezero_tickInplace

oneZeroTick :: OneZero -> StkFrames -> StkFrames -> Word32 -> Word32 -> IO ()
oneZeroTick = createStkFramesTickFun unhandledOneZeroAction c_emfb_stk_onezero_tick
