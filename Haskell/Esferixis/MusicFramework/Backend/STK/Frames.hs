...
foreign import ccall "emfb_stk_stkframes_channels" c_emfb_stk_frames_channels :: FramesPtr -> IO CInt
foreign import ccall "emfb_stk_stkframes_delete" c_emfb_stk_frames_delete :: FramesPtr -> IO ()
